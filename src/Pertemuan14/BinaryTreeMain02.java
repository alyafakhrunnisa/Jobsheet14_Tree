...
public class BinaryTreeMain02 {
    public static void main(String[] args) {
        ...
        bstRekursif.addRekursif(new Mahasiswa02("244160121", "Ali", "A", 3.57));
        bstRekursif.addRekursif(new Mahasiswa02("244160221", "Badar", "B", 3.85));
        bstRekursif.addRekursif(new Mahasiswa02("244160185", "Candra", "C", 3.21));
        bstRekursif.addRekursif(new Mahasiswa02("244160220", "Dewi", "B", 3.54));
        bstRekursif.addRekursif(new Mahasiswa02("244160131", "Devi", "A", 3.72));
        bstRekursif.addRekursif(new Mahasiswa02("244160205", "Ehsan", "D", 3.37));
        bstRekursif.addRekursif(new Mahasiswa02("244160170", "Fizi", "B", 3.46));
